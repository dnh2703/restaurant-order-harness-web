...
describe('StaffLoginPage', () => {
  it('submits the entered credentials', async () => {
    ...
    fireEvent.change(screen.getByPlaceholderText('admin@gmail.com'), {
  ...
  it('shows the error message when login rejects', async () => {
    ...
    render(<StaffLoginPage onSubmit={onSubmit} />)
    fireEvent.change(screen.getByPlaceholderText('admin@gmail.com'), { target: { value: 'x' } })
    fireEvent.change(screen.getByPlaceholderText(/Nhập mật khẩu/), { target: { value: 'y' } })
    fireEvent.click(screen.getByRole('button', { name: /Đăng nhập/ }))
