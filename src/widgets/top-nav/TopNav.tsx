...
export function TopNav({
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-line bg-white px-4 lg:px-0 py-3 sm:flex-row sm:items-center sm:justify-between">
      <div className="max-w-[1360px] mx-auto flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between lg:px-6">
